...
function final_report() {
    ...
    echo
    echo -e "${BLUE}=============================================================================${NC}"
    echo -e "${GREEN}XBI ${CYAN}Masternode Setup Script by ${GREEN}sehidcan${NC}"
    echo -e "${YELLOW}--> XBI      : ${PURPLE}B83m3GmwTp1b6mRY5LeaxH5rzqH7411cWi${NC}"
    echo -e "${YELLOW}--> Vultr ref: ${PURPLE}https://www.vultr.com/?ref=7429408${NC}"
    echo -e "${BLUE}=============================================================================${NC}"
